...
const Navbar = () => {
  ...
  return (
    <div className="fixed top-0 left-0 right-0 w-full flex items-center justify-between px-6 md:px-16 lg:px-36 py-5 z-50">
      <Link to="/" className="max-md:flex-1">
        <img src={navbar_logo} alt="Logo" className="w-34 h-17" />
      </Link>
        ...
        {!user ? (
          ...
          <UserButton>
            <UserButton.MenuItems>
              <UserButton.Action
                label="Cart"
                labelIcon={<ShoppingCart width={15} />}
